...
def parse_arguments():
    ...
    path_group.add_argument('--output-directory', type=str, default='database/simlingo_v2_2026_07_21_16_16_03/commentary',
                            help='Output directory for the vqa-graph')  # 保存Commentary标签的目录
    path_group.add_argument('--output-examples-directory', type=str, default='database/simlingo_v2_2026_07_21_16_16_03/commentary',
